...
namespace EntityStates.Toolbot
{
    public class Reboot : BaseCharacterMain
    {
        ...
        public static float entryDuration = 0.4f;
        public static float baseDuration = 3f;
        public static GameObject hudOverlayPrefab;
        public static GameObject cleanseBodyEffectPrefab;
        ...
        {
            base.OnEnter();
            duration = (baseDuration / attackSpeedStat) + entryDuration;
        ...
        public void CleanseBodyStep()
        {
            ...
            EffectManager.SpawnEffect(cleanseBodyEffectPrefab, new EffectData
            {
